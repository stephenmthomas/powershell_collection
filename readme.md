...
7. **svg_scrub_path2symbol.ps1** - searches same directory for all SVG files, scrubs the path data from them, concatenates it, and then outputs a symbol element - useful for creating SVG "spritesheets."
